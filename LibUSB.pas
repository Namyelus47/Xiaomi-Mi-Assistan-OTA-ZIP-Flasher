...
type
  ...
  plibusb_device = ^libusb_device;
    ...
    // An array of pointers to libusb_device. Adjust the size as necessary.
  Plibusb_device_array = array[0..1023] of Plibusb_device;  // Define a sufficiently large array

  // Pointer to the array of device pointers
  PPlibusb_device_array = ^Plibusb_device_array;
...
//------------------------------------------------------------------------------
//******************************************************************************
function libusb_init(ctx:PPlibusb_context):longint;stdcall;external 'libusb-1.0.dll';
procedure libusb_exit(ctx:Plibusb_context);stdcall;external 'libusb-1.0.dll';
procedure libusb_set_debug(ctx:Plibusb_context; level:integer);stdcall;external 'libusb-1.0.dll';

function libusb_get_device_list(ctx:Plibusb_context; list: PPlibusb_device): size_t;stdcall;external 'libusb-1.0.dll';
procedure libusb_free_device_list(list:PPlibusb_device; unref_devices:integer);stdcall;external 'libusb-1.0.dll';
function libusb_get_configuration(dev: Plibusb_device_handle; config: PLongint): Integer;stdcall;external 'libusb-1.0.dll';

function libusb_get_device_descriptor(dev: Plibusb_device; desc:Plibusb_device_descriptor): Integer;stdcall;external  'libusb-1.0.dll';
function libusb_get_active_config_descriptor(dev: Plibusb_device; config:PPlibusb_config_descriptor): Integer;stdcall;external  'libusb-1.0.dll';

function libusb_get_config_descriptor(dev: Plibusb_device;config_index:uint8_t; config: PPlibusb_config_descriptor):Integer;stdcall;external  'libusb-1.0.dll';

function libusb_get_max_packet_size(dev: Plibusb_device; endpoint: Byte): Integer;stdcall;external  'libusb-1.0.dll';
function libusb_get_max_iso_packet_size(dev: Plibusb_device; endpoint: Byte): Integer;stdcall;external 'libusb-1.0.dll';

function libusb_open(dev: Plibusb_device; handle: PPlibusb_device_handle): Integer;stdcall;external 'libusb-1.0.dll';
procedure libusb_close(dev_handle:Plibusb_device_handle);stdcall;external  'libusb-1.0.dll';
function libusb_get_device(dev_handle: Plibusb_device_handle): Plibusb_device;stdcall;external  'libusb-1.0.dll';

function libusb_set_configuration(dev: Plibusb_device_handle; configuration: Integer): Integer;stdcall;external  'libusb-1.0.dll';

function libusb_claim_interface(dev: Plibusb_device_handle; iface: Integer): Integer;stdcall;external  'libusb-1.0.dll';
function libusb_release_interface(dev: Plibusb_device_handle; iface: Integer): Integer;stdcall;external 'libusb-1.0.dll';

function libusb_open_device_with_vid_pid(ctx: Plibusb_context; vendor_id: uint16_t; product_id: uint16_t): Plibusb_device_handle;stdcall;external  'libusb-1.0.dll';

function libusb_set_interface_alt_setting(dev: Plibusb_device_handle;interface_number: Integer;alternate_setting: Integer): Integer;stdcall;external 'libusb-1.0.dll';
function libusb_clear_halt(dev: Plibusb_device_handle; endpoint: BYTE): Integer;stdcall;external 'libusb-1.0.dll';
function libusb_reset_device(dev: Plibusb_device_handle): Integer;stdcall;external  'libusb-1.0.dll';

function libusb_kernel_driver_active(dev: Plibusb_device_handle; theinterface: Integer): Integer;stdcall;external 'libusb-1.0.dll';
function libusb_detach_kernel_driver(dev: Plibusb_device_handle; theinterface: Integer): Integer;stdcall;external 'libusb-1.0.dll';
function libusb_attach_kernel_driver(dev: Plibusb_device_handle; theinterface: Integer): Integer;stdcall;external 'libusb-1.0.dll';
//------------------------------------------------------------------------------
// Async I/O
//------------------------------------------------------------------------------
function libusb_submit_transfer(transfer: Pstructlibusb_transfer):Integer;stdcall;external 'libusb-1.0.dll';
function libusb_cancel_transfer(transfer: Pstructlibusb_transfer):Integer;stdcall;external 'libusb-1.0.dll';
procedure libusb_free_transfer(transfer: Pstructlibusb_transfer);stdcall;external 'libusb-1.0.dll';
function libusb_alloc_transfer(iso_packets:integer):Pstructlibusb_transfer;stdcall;external 'libusb-1.0.dll';
//------------------------------------------------------------------------------
// Sync I/O
//------------------------------------------------------------------------------
function libusb_control_transfer(dev_handle: Plibusb_device_handle; request_type: uint8_t; request: uint8_t; value: uint16_t; index: uint16_t; data: PChar; length:uint16_t;timeout: DWORD):Integer;stdcall;external 'libusb-1.0.dll';
function libusb_bulk_transfer(dev_handle: Plibusb_device_handle; endpoint:BYTE; data: Pchar; length:integer;actual_length:Plongint; timeout:DWORD):Integer;stdcall;external 'libusb-1.0.dll'; //tested
function libusb_interrupt_transfer(dev_handle: Plibusb_device_handle; endpoint:byte; data:Pchar; length:integer; actual_length:Plongint; timeout:DWORD):Integer;stdcall;external 'libusb-1.0.dll';    //tested

function libusb_get_string_descriptor_ascii(dev:plibusb_device_handle ;index:uint8_t; data:Pchar; length:integer):Integer;stdcall;external 'libusb-1.0.dll';

{/* polling and timeouts */}
function libusb_try_lock_events(ctx:Plibusb_context):integer;stdcall;external 'libusb-1.0.dll';
procedure libusb_lock_events(ctx:Plibusb_context);stdcall;external 'libusb-1.0.dll';
procedure libusb_unlock_events(ctx:Plibusb_context);stdcall;external 'libusb-1.0.dll';
function libusb_event_handling_ok(ctx:Plibusb_context):integer;stdcall;external 'libusb-1.0.dll';
function libusb_event_handler_active(ctx:Plibusb_context):integer;stdcall;external 'libusb-1.0.dll';
procedure libusb_lock_event_waiters(ctx:Plibusb_context); stdcall;external 'libusb-1.0.dll';
procedure libusb_unlock_event_waiters(ctx:Plibusb_context); stdcall;external 'libusb-1.0.dll';

const
  LIBUSB_OPTION_USE_USBDK = 1;

// libusb_set_option (added in libusb 1.0.22) - variadic, must be cdecl
// libusb_error_name - may not be in older builds
// Both loaded dynamically so the app works with any libusb version
type
  Tlibusb_set_option = function(ctx: Plibusb_context; option: Integer): Integer; cdecl;
  Tlibusb_error_name = function(errcode: Integer): PAnsiChar; cdecl;

function libusb_set_option_available: Boolean;
function libusb_set_option(ctx: Plibusb_context; option: Integer): Integer;
function libusb_error_name(errcode: Integer): PAnsiChar;

implementation

var
  _libusb_set_option: Tlibusb_set_option = nil;
  _libusb_error_name: Tlibusb_error_name = nil;
  _libusb_dll_handle: THandle = 0;
  _libusb_extras_loaded: Boolean = False;

procedure LoadLibusbExtras;
begin
  if _libusb_extras_loaded then Exit;
  _libusb_extras_loaded := True;

  _libusb_dll_handle := GetModuleHandle('libusb-1.0.dll');
  if _libusb_dll_handle = 0 then
    _libusb_dll_handle := LoadLibrary('libusb-1.0.dll');
  if _libusb_dll_handle = 0 then Exit;

  @_libusb_set_option := GetProcAddress(_libusb_dll_handle, 'libusb_set_option');
  @_libusb_error_name := GetProcAddress(_libusb_dll_handle, 'libusb_error_name');
end;

function libusb_set_option_available: Boolean;
begin
  LoadLibusbExtras;
  Result := Assigned(_libusb_set_option);
end;

function libusb_set_option(ctx: Plibusb_context; option: Integer): Integer;
begin
  LoadLibusbExtras;
  if Assigned(_libusb_set_option) then
    Result := _libusb_set_option(ctx, option)
  else
...
begin
  LoadLibusbExtras;
  if Assigned(_libusb_error_name) then
    Result := _libusb_error_name(errcode)
  else
    Result := 'unknown';
end;
